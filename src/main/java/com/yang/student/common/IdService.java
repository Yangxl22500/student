 ...
 * @author:      wzhang
 * @version      V1.0
 * Createdate:   2019年4月19日 下午3:08:38
...
public class IdService {
    ...
    private long datacenterIdBits = 0L;                                 //  数据中心ID长度
    ...
    public static void main(String[] args) {
    	...
    	IdService service = IdService.get();
